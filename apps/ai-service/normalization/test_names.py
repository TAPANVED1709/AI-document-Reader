...
class TestNameNormalizer:
    ...
    GROUPS = {
        ...
        "Glucose": ["glucose", "blood glucose", "fasting glucose", "fasting blood sugar", "fbs", "fasting plasma glucose", "ppbs", "post prandial blood sugar", "random blood sugar", "random glucose", "pp glucose", "estimated average glucose", "rbs"],
        ...
        "Total Cholesterol": ["total cholesterol", "cholesterol"], "HDL": ["hdl", "hdl cholesterol"], "Non-HDL cholesterol": ["non-hdl cholesterol", "non hdl cholesterol"],
